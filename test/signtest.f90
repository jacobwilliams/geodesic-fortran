...
i = i + chrnd0(-eps/64, -0.0_wp   )
i = i + chrnd0(-  0.0_wp , -0.0_wp   )
i = i + chrnd0(   0.0_wp , +0.0_wp   )
i = i + chrnd0( eps/64, +0.0_wp   )
i = i + chrnd0( eps/32, +eps/32)
i = i + chrnd0((1-2*eps)/64, (1-2*eps)/64)
i = i + chrnd0((1-eps  )/64,  1.0_wp     /64)
i = i + chrnd0((1-eps/2)/64,  1.0_wp     /64)
i = i + chrnd0((1-eps/4)/64,  1.0_wp     /64)
i = i + chrnd0( 1.0_wp     /64,  1.0_wp     /64)
i = i + chrnd0((1+eps/2)/64,  1.0_wp     /64)
i = i + chrnd0((1+eps  )/64,  1.0_wp     /64)
i = i + chrnd0((1+2*eps)/64, (1+2*eps)/64)
i = i + chrnd0((1-eps  )/32, (1-eps  )/32)
i = i + chrnd0((1-eps/2)/32,  1.0_wp     /32)
i = i + chrnd0((1-eps/4)/32,  1.0_wp     /32)
i = i + chrnd0( 1.0_wp     /32,  1.0_wp     /32)
i = i + chrnd0((1+eps/2)/32,  1.0_wp     /32)
i = i + chrnd0((1+eps  )/32, (1+eps  )/32)
i = i + chrnd0((1-eps  )/16, (1-eps  )/16)
i = i + chrnd0((1-eps/2)/16, (1-eps/2)/16)
i = i + chrnd0((1-eps/4)/16,  1.0_wp     /16)
i = i + chrnd0( 1.0_wp     /16,  1.0_wp     /16)
i = i + chrnd0((1+eps/4)/16,  1.0_wp     /16)
i = i + chrnd0((1+eps/2)/16,  1.0_wp     /16)
i = i + chrnd0((1+eps  )/16, (1+eps  )/16)
i = i + chrnd0((1-eps  )/ 8, (1-eps  )/ 8)
i = i + chrnd0((1-eps/2)/ 8, (1-eps/2)/ 8)
i = i + chrnd0((1-eps/4)/ 8,  1.0_wp     / 8)
i = i + chrnd0((1+eps/2)/ 8,  1.0_wp     / 8)
i = i + chrnd0((1+eps  )/ 8, (1+eps  )/ 8)
i = i + chrnd0( 1-eps      ,  1-eps      )
i = i + chrnd0( 1-eps/2    ,  1-eps/2    )
i = i + chrnd0( 1-eps/4    ,  1.0_wp        )
i = i + chrnd0( 1.0_wp        ,  1.0_wp        )
i = i + chrnd0( 1+eps/4    ,  1.0_wp        )
i = i + chrnd0( 1+eps/2    ,  1.0_wp        )
i = i + chrnd0( 1+eps      ,  1+  eps    )
i = i + chrnd0( 90.0_wp-64*eps,  90-64*eps  )
i = i + chrnd0( 90.0_wp-32*eps,  90.0_wp       )
i = i + chrnd0( 90.0_wp       ,  90.0_wp       )
